      ...
      >
        ...
        >
          ...
          <p
            ...
            text-[9px] leading-[12px]`}
          >
            Anyone can utilise <span className="font-[Regular]">0racle</span>{" "}
        ...
        >
          ...
          >
            The <span className="font-[Regular] tracking-tight">0racle</span>{" "}
        ...
        >
          ...
          <p
            ...
            text-[9px] leading-[10.5px] tracking-[0.6px]`}
          >
            <span className="font-[Regular]">0racle</span> provides secure path
